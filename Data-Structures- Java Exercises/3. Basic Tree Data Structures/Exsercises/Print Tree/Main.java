...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        readTree();
        String indentation = "";
        printTree(findRoot(), indentation);
    }
    ...
    public static void printTree(Tree<Integer> parent, String indentation){
        System.out.println(indentation+parent.value);
        for (Tree<Integer> child: parent.children){
