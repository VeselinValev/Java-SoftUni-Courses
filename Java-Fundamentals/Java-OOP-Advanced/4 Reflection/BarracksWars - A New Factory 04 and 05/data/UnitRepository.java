...
public class UnitRepository implements Repository {
    ...
    private final String NO_SUCH_UNIT = "No such units in repository.";
    ...
    public void removeUnit(String unitType) {
        if (this.amountOfUnits.containsKey(unitType) && this.amountOfUnits.get(unitType) > 0) {
            ...
            throw new IllegalStateException(unitType + " retired!");
        } else {
            throw new IllegalStateException(NO_SUCH_UNIT);
        }
    }
}
