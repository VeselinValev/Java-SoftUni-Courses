...
import app.models.dtos.views.CarWithoutParts;
...
public class SaleServiceImpl implements SaleService {
    ...
    public List<SaleWIthDiscount> getAllSalesWithDiscount() {
        ...
        for (Sale sale: sales){
            ...
            CarWithoutParts carWithoutParts = this.modelMapper.map(sale.getCar(), CarWithoutParts.class);
            saleWIthDiscount.setCar(carWithoutParts);
