...
public class ConsoleRunner implements CommandLineRunner {
    ...
    private void printAllBooksByGeorgePowell() {
        for (String title : bookService.findBooksByAuthorFirstNameAndAuthorLastNameOrderByReleaseDateAndTitle()) {
            System.out.println(title);
        }
    }

    private void printAuthorsByBookCount() {
        for (String authorName : authorService.findAllByOrderByBooksDesc()) {
            System.out.println(authorName);
        }
    }

    private void printAuthorsWithBooksReleaseDateBefore1990() {
        for (String authorName : authorService.findAuthorsByBooksReleaseDateBefore1990()) {
            System.out.println(authorName);
        }
    }
