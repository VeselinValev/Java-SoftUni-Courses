...
public class BookServiceImpl implements BookService{
    ...
    @Override
    public List<String> findBooksByAuthorFirstNameAndAuthorLastNameOrderByReleaseDateAndTitle() {
        return this.bookRepository.findBooksByAuthorFirstNameAndAuthorLastNameOrderByReleaseDateDescTitleAsc();
    }
}
